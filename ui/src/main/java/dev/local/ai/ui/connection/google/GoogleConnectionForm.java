...
/**
 * Form controller for creating a Google Gemini connection.
 */
public class GoogleConnectionForm implements Initializable {

    private static final Logger logger = LoggerFactory.getLogger(GoogleConnectionForm.class);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        logger.debug("Initializing GoogleConnectionForm");
        setupDefaultValues();
        setupEventHandlers();
        logger.debug("GoogleConnectionForm initialized");
    }

    private void setupDefaultValues() {
        titleLabel.setText("New Google Gemini Connection");
    }

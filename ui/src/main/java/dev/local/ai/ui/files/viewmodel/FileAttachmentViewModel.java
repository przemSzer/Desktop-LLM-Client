...
public class FileAttachmentViewModel {
    ...
    public FileAttachmentViewModel(CommandManager commandManager, FileSelector fileSelector) {
        if (commandManager == null) {
            throw new IllegalArgumentException("Command manager cannot be null");
        }
        this.commandManager = commandManager;
        if (fileSelector == null) {
            throw new IllegalArgumentException("File selector cannot be null");
        }
    ...
    public void selectAndAddFiles() {
        try {
            var selectedFiles = fileSelector.getMultiple();
            for (var selectedFile : selectedFiles) {
                addFileToViewAndStartProcessing(selectedFile);
            }
    ...
    public void addFileToViewAndStartProcessing(File selectedFile) {
        var fileViewModel = new AttachedFileViewModel(new DocumentDescription(selectedFile.getName(), null, null, selectedFile), FileStatus.LOADING);
    ...
    private boolean addFile(AttachedFileViewModel fileViewModel) {
